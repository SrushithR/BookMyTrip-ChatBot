...
if __name__ == '__main__':
    input_to_lambda = {
        "currentIntent": {"slots": {"RoomType": None, "CheckInDate": None, "Nights": None, "Location": None},
                          "confirmationStatus": "None", "name": "BookHotel",
                          "slotDetails": {"RoomType": {"originalValue": None, "resolutions": []},
                                          "CheckInDate": {"originalValue": None, "resolutions": []},
                                          "Nights": {"originalValue": None, "resolutions": []},
                                          "Location": {"originalValue": None, "resolutions": []}}},
        "userId": "0ct91y2f3zg1himmxne5109u2rim9ppj",
        "bot": {"alias": "$LATEST", "version": "$LATEST", "name": "BookTrip"}, "inputTranscript": "book a hotel",
        "requestAttributes": None, "invocationSource": "DialogCodeHook", "outputDialogMode": "Text",
        "messageVersion": "1.0", "sessionAttributes": {}}
